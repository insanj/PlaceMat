...
- (void)viewDidLoad {
	...
	welcome.center = CGPointMake(self.view.center.x, self.view.center.y - welcome.frame.size.height);
	welcome.font = [UIFont fontWithName:@"HelveticaNeue-UltraLight" size:50.0];
	welcome.textAlignment = NSTextAlignmentCenter;
	welcome.textColor = [UIColor blackColor];
	welcome.text = @"Welcome";
	
	UILabel *glad = [[UILabel alloc] initWithFrame:CGRectMake(0.0, welcome.frame.origin.y + welcome.frame.size.height, self.view.frame.size.width, 50.0)];
	...
	createAccount.center = CGPointMake(createAccount.center.x, (glad.center.y + (glad.frame.size.height / 2.0)) + 50.0);
	...
	login.center = CGPointMake(login.center.x, (createAccount.center.y + (createAccount.frame.size.height / 2.0)) + 15.0);
	...
	facebook.center = CGPointMake(facebook.center.x, (login.center.y + (login.frame.size.height / 2.0)) + 15.0);
